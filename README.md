...
- **Bibliothek um Standard-Übungen ergänzen** – unter *Einstellungen → Daten & Sicherung* lassen sich neue Übungen aus der kuratierten Bibliothek nachträglich ergänzen, ohne bereits vorhandene eigene Übungen zu verändern oder zu löschen (rein additiv).
