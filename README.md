...
- **Supersätze/Zirkel** – Übungen ohne Pause dazwischen zu einer Gruppe verbinden: im Trainingstag per Mehrfachauswahl („🔗 Zirkel erstellen"), oder direkt im laufenden Training über das „⋮"-Menü („Mit nächster Übung verbinden"/„Zirkel auflösen"). Gruppierte Übungen werden sichtbar zusammengefasst; der Pausen-Timer startet erst nach der letzten Übung der Gruppe.
- **Schlanker Übungskopf im Training** – nur Name + „⋮"-Menü. Darin: Pause ändern, Satz hinzufügen/entfernen, Notiz, **Übung ersetzen**, **Reihenfolge nach oben/unten verschieben**, **Zirkel verbinden/auflösen**, Übung entfernen.
